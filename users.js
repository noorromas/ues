...
var me_user1=setInterval(function(){
	...
	$("#users .uzr.stl1 .c-flex.fr").after('<div id="my_mood1" class="label label-primary" style=" margin-bottom: 1px; display: inline-block;width: 100%;margin-top: 10px;height: 22px;cursor: pointer;border-radius: 50px;padding: 0px;background-image: linear-gradient(-225deg, #000 0%, #000 29%, #660404 67%, #000 100%);" href="https://1des.net/">أنام هرباً لا تعباً </div>');
        $("#users .uzr.stl1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://up6.cc/2025/06/175063923490761.png">');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.instagram.com/reel/DLNP651tmqw/?utm_source=ig_web_copy_link" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
var l_itvaiah=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('- عَـهد')").addClass('aiah1');
