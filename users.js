...
var me_user1=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr:contains('Nour Aldeen')").addClass('stl1');
        

$("#users .uzr span.u-topic:contains('Nour Aldeen')").after('<img id="mystory1" class="My_vedio1" title="ستوري" src="https://i.ibb.co/47VS4nY/image.png">');
