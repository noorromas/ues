...
var me_user1=setInterval(function(){
	...
	$("#users .uzr.stl1 span.u-topic").after('<img id="mystory1" class="My_vedio1" title="ستوري" style="float: right;width: 20px;margin-top: 0px;margin-right: 5px;cursor: pointer;" src="https://i.ibb.co/47VS4nY/image.png">');
        ...
        $("#movon1").append('<iframe id="ifr_mov1" style="max-width: 340px;min-width: 300px;right: 0; top: 35px; left: auto;" class="modal in" role="dialog" style="z-index: 2100; display: none; style="max-width:240px;" src="https://www.youtube.com/embed/2CXk5TnGZnw" allowfullscreen="" width="338" height="490" frameborder="0"></iframe>');
...
var l_itvdham=setInterval(function(){
    if(myid!=null){
        ...
        $("#users .uzr.dham1 .fitimg.u-pic").append('<img class="dham_star1" src="https://up6.cc/2025/06/17506582542231.png">');
